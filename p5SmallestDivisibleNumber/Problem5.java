...
public class Problem5 {
    ...
    public static void main(String[] args) {
         ...
         * we can start there!
         * 
         * We set the result to 2520, and then start calculating 
         * from 10 to 20. 
         * 
         * We could just as easily start at 1, but it would be slower.
         */
        int result = 2520;
         ...
         * but we used already used that approach in Problem 3.
         */
